...
public class AMTooltipViewOptions{
    ...
    public init(
        ...
        textColor:UIColor = UIColor(red: 248.0/255.0, green: 119.0/255.0, blue: 20.0/255.0, alpha: 1.0), //UIColor.white,
        ...
        textBoxBorderColor:UIColor = UIColor(red: 248.0/255.0, green: 119.0/255.0, blue: 20.0/255.0, alpha: 1.0), //UIColor.clear,
        ...
        dotBorderColor:UIColor = UIColor(red: 248.0/255.0, green: 119.0/255.0, blue: 20.0/255.0, alpha: 1.0), //UIColor.white,
...
open class AMTooltipView: UIView {
    ...
    func show(){
        ...
        var twoA = cutOutViewWidth.constant/2
        var twoB = (options.textWidth + padding*2)/2
       
            let spaceFromLeftSide = cutOutViewX.constant + twoA - twoB
        ...
        var oneA = cutOutViewWidth.constant/2
        var oneB = (options.textWidth + padding*2)/2
            let spaceFromRightSide = cutOutViewX.constant + oneA + oneB
