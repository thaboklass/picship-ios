...
//openShipPicFromOriginalMessageTap

/// Thet Messages view controller - the messages list
class MessagesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, MessagesCellDelegate {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "Message") as? MessagesCell {
            if currentUser != nil {
                if message.sender == recipient || message.sender == currentUser! {
                    cell.configCell(message: message, originIsMainMessages: true, parentViewController: self)
                }
            }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "openShipPicFromOriginalMessageTap") {
            print("Inside segue")
