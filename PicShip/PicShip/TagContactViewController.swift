//
//  TagContactViewController.swift
//  PicShip
//
//  Created by Thabo David Klass on 08/07/2019.
...
class TagContactViewController: UITableViewController {
    ...
    var userDataDelegate: TagContactViewControllerDelegate?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let userName = registeredContact.fullName
        
        if userID != currentUser! {
            self.userDataDelegate!.setUserData(userID: userID, userName: userName)
...
extension TagContactViewController: UISearchResultsUpdating {
